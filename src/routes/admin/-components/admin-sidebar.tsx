          ...
          <div className="flex items-center">
            ...
            >
              <Link to="/" className="flex">
                <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-white text-sidebar-primary-foreground mr-3">
                  <img src="https://images.toolfinder.co/tools/380/logo/pipedrive-logo.png?h=256&fm=webp&fit=pad&w=256&q=100" alt="ELTL" />
                </div>
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Pipedrive</span>
