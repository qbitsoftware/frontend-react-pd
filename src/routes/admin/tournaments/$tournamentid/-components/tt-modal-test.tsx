...
export const TableTennisProtocolModalTest: React.FC<ProtocolModalProps> = ({
  isOpen,
  onClose,
  match,
  tournament_id,
            ...
            >
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <Input
                          ...
                          placeholder={team === 1 ? "Kapten AB" : "Kapten XY"}
              ...
              <div className="flex justify-end mt-1 px-3">
                <Button
                  ...
                  size="sm"
                  className="text-white/90 h-8 px-3 text-sm mb-2 ml-auto self-end"
                >
                  Alusta mängu
                </Button>
              </div>
