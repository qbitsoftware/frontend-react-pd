...
export const ParticipantsForm: React.FC<ParticipantFormProps> = ({
  ...
  const { data: matches_data, isLoading } = UseGetMatchesQuery(
    tournament_data.id,
    table_data.id
  );
  ...
  const { data: playerSuggestions, refetch } =
  ...
  const updateDropdownPosition = useCallback(
    (e: React.FocusEvent<HTMLInputElement>, id: string) => {
  ...
  useEffect(() => {
    const handleScroll = (e: Event) => {
      if (focusedField) {
        ...
        const isSuggestionDropdown =
          target.classList.contains("suggestion-dropdown") ||
                    ...
                    <TableRow>
                      {table_data && table_data.solo ? (
                        ...
                        <>
                          ...
                          <TableHead className="">
                            {t(
                              "admin.tournaments.groups.participants.table.team"
                            )}
                          </TableHead>
                          <TableHead className="">
                            {t(
                                ...
                                {focusedField === "name" &&
                                  ...
                                  playerSuggestions.data.length > 0 && (
                                    <div
                                      ...
                                      style={{
                                        left:
                                          dropdownPositions[participant.id]
                                            ?.left || 0,
                                        width:
                                          dropdownPositions[participant.id]
                                            ?.width || 200,
                            ...
                            <TableCell className="pl-8">
                              <div className="flex relative">
                                ...
                                {focusedField === "name" &&
                                  ...
                                  playerSuggestions.data.length > 0 && (
                                    <div
                                      className="fixed max-h-[200px] overflow-y-auto py-1 bg-background border rounded-md shadow-lg z-50 suggestion-dropdown"
                                      style={{
                                        left:
                                          dropdownPositions[participant.id]
                                            ?.left || 0,
                              ...
                              {focusedField === "name" &&
                                ...
                                playerSuggestions.data.length > 0 && (
                                  <div
                                    ...
                                    style={{
                                      left:
                                        dropdownPositions["soloInput"]?.left ||
                                        0,
                                      width:
                                        dropdownPositions["soloInput"]?.width ||
                                        200,
                                      ...(dropdownPositions["soloInput"]
                                        ?.position === "top"
                                        ? {
                                            bottom:
                                              window.innerHeight -
                                        ...
                                        : {
                                            top: dropdownPositions["soloInput"]
                                              ?.top,
                                            maxHeight:
                                              window.innerHeight -
                                              dropdownPositions["soloInput"]
